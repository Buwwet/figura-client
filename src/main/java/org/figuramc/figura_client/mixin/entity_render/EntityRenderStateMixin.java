...
public class EntityRenderStateMixin implements EntityRenderStateAccess {
    ...
    @Override public Entity figura_client$getEntity() { return entity; }
    @Override public void figura_client$setEntity(Entity entity) { this.entity = entity; }
    @Override public float figura_client$getTickDelta() { return tickDelta; }
    @Override public void figura_client$setTickDelta(float tickDelta) { this.tickDelta = tickDelta; }
}
