...
public abstract class OldModelPartMixin implements ModelPartAccess {
...
//                VanillaPart vanillaPart = ((OldModelPartMixin) (Object) part).vanillaPart;
//                if (vanillaPart != null) {
//                    currentPart = currentComponent.vanillaPartToScriptPart.get(vanillaPart); // Update currentPart
//                    if (currentPart != null) {
//                        ((OldModelPartMixin) (Object) part).figuraCustomRender(poseStack, vertexConsumer, i, j, k);
//                        continue;
//                    }
//                }
...
//        AvatarView<?> peeked = FiguraClient.AVATAR_RENDERING_STACK.peek();
//        if (peeked == null) return false;
//        VanillaRendering vanillaRendering = peeked.get().getComponent(VanillaRendering.TYPE);
//        if (vanillaRendering == null) return false;
//        VanillaRendering.ScriptVanillaPart scriptPart = vanillaPart == null ? null : vanillaRendering.vanillaPartToScriptPart.get(vanillaPart);
//        if (scriptPart == null) return false;
//        currentComponent = vanillaRendering;
//        currentPart = scriptPart;
//        Boolean b = FiguraClient.IS_LIVING_ENTITY_STACK.peek();
//        isLiving = b != null && b;
//        return true;
//    }
//
